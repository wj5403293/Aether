...
private val LlmReconnectDelayScheduleMillis = listOf(5_000L, 10_000L, 12_000L, 15_000L, 20_000L)
...
private class LlmInactivityTimeoutException(
    timeoutMillis: Long,
) : java.io.IOException(
    "LLM inactivity timeout after ${timeoutMillis / 1000} seconds without any response activity."
)

private class LlmInactivityTimeoutCancellationException(
    message: String,
