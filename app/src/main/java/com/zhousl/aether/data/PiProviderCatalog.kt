...
object PiProviderCatalog {
    val providers: List<PiProviderDefinition> = listOf(
        ...
        builtin("google-vertex", "Google Vertex AI", "", "gemini-2.5-flash", supportsAmbientAuth = true, category = "Recommended"),
        ...
        builtin("amazon-bedrock", "Amazon Bedrock", "", "amazon.nova-2-lite-v1:0", supportsAmbientAuth = true, category = "Cloud"),
